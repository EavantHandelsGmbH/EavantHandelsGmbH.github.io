...
export function LanguageProvider({ children }) {
  ...
  const t = useCallback(
    (path) => {
      const read = (obj) => path.split('.').reduce((acc, k) => (acc == null ? undefined : acc[k]), obj)
  ...
  const value = useMemo(() => ({ lang, setLang, dir, t, isRTL: dir === 'rtl', langs: LANGS }), [lang, dir, t, setLang])
